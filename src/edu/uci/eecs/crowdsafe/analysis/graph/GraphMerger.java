package edu.uci.eecs.crowdsafe.analysis.graph;
...
import edu.uci.eecs.crowdsafe.analysis.graph.debug.MatchingInstance;
import edu.uci.eecs.crowdsafe.analysis.graph.debug.MatchingType;
...
import edu.uci.eecs.crowdsafe.analysis.graph.representation.MatchedNodes;
import edu.uci.eecs.crowdsafe.analysis.graph.representation.ModuleGraph;
import edu.uci.eecs.crowdsafe.analysis.graph.representation.MutableInteger;
import edu.uci.eecs.crowdsafe.analysis.graph.representation.Node;
import edu.uci.eecs.crowdsafe.analysis.graph.representation.NodeList;
import edu.uci.eecs.crowdsafe.analysis.graph.representation.NormalizedTag;
import edu.uci.eecs.crowdsafe.analysis.graph.representation.PairNode;
import edu.uci.eecs.crowdsafe.analysis.graph.representation.PairNodeEdge;
import edu.uci.eecs.crowdsafe.analysis.graph.representation.SpeculativeScoreList;
import edu.uci.eecs.crowdsafe.analysis.graph.representation.SpeculativeScoreRecord;
...
public class GraphMerger {
	...
	public static void main(String[] args) {
		...
		System.out.println("### --------------- ###");
		ProcessExecutionGraph graph0 = ExecutionGraphDataLoader.loadProcessGraph(run0);
		ProcessExecutionGraph graph1 = ExecutionGraphDataLoader.loadProcessGraph(run1);
