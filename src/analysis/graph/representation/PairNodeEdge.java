 ...
 * parentNode2 is from graph2, which is traversed. curNodeEdge2 is the
 * edge which comes from parentNode2. When you use this class, you can
 * assume that parentNode1 and parentNode2 are matched and you are trying
 * to match the "toNode" of curNodeEdge2.
 * @author peizhaoo
 *
 */
public class PairNodeEdge {
	...
	public int hashCode() {
		return parentNode1.hashCode() << 5 ^ parentNode2.hashCode() << 5 ^ curNodeEdge2.hashCode();
	}
}
