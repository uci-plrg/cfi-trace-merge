...
#set size 100,100
plot  "unique_hash.dat" using 1:($2 + 1) title 'new-pairs' with lines, "" using 1:($3 + 1) title 'new-blocks' with lines, "" using 1:5 title 'total-pairs' with lines, "" using 1:6 title 'total-blocks' with lines, "" using 1:4 title 'hash-per-run' with l
